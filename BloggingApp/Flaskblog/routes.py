...
def npd():
    return render_template("npd.html", link=r"https://github.com/Aryan566-wq/Google-Classroom-Clone/blob/main/exe%20files/ToDoApp.zip")
@app.route("/download/notepad")
def npdd():
    return render_template("npd.html", link=r"https://github.com/Aryan566-wq/Google-Classroom-Clone/blob/main/exe%20files/Notepad%20(1).zip")    

@app.route("/download/scanner")
def npddd():
    return render_template("npd.html", link=r"https://github.com/Aryan566-wq/Google-Classroom-Clone/blob/main/exe%20files/doc_scanner.txt")    
@app.route("/download/assistant")
def npdddd():
    return render_template("npd.html", link=r"https://github.com/Aryan566-wq/Google-Classroom-Clone")    
